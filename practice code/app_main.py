...
MEASUREMENT_PERIOD = 1800  # Measurement period (seconds) in an hour
DESIRED_FRIDGE_TEMP = 8  # Desired temperature inside the fridge (Celsius)
SOLAR_PANEL_AREA = 2  # Area of the solar panel (square meters)
SOLAR_PANEL_EFFICIENCY = 0.15  # Solar panel efficiency (decimal)
INVERTER_EFFICIENCY = 1  # Inverter efficiency (decimal)
